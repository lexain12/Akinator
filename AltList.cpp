...
void myGraph (List_t* list)
{
    ...
    FILE* GraphFilePtr = fopen(GraphFileAlt, "w");
...
void listHeadDelete (List_t* list)
{
    listDelete (list, list->nullElement->nextElementInd);
}

void listTailDelete (List_t* list)
{
    listDelete (list, list->nullElement->prevElementInd);
}

ListElement* listTail (List_t* list)
{
    return list->nullElement->prevElementInd;
}

ListElement* listHead (List_t* list)
{
    return list->nullElement->nextElementInd;
}
